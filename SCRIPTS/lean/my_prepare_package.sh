...
## 设置地址库
sed -i 's#https://cdn.jsdelivr.net/gh/YW5vbnltb3Vz/domain-list-community@release/gfwlist.txt#https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/gfw.txt#' root/etc/init.d/shadowsocksr
sed -i 's#https://ispip.clang.cn/all_cn.txt#https://cdn.jsdelivr.net/gh/QiuSimons/Chnroute@master/dist/chnroute/chnroute.txt#' root/etc/init.d/shadowsocksr
popd
